...
export default function Home() {
  ...
  return (
    <div>
      {/* top */}
        <div className="flex flex-col gap-6 font-extrabold mt-36 px-3 max-w-6xl mx-auto">
          <h1 className="text-slate-700 font-bold text-3xl lg:text-6xl">
            Find  your  next <span className="text-slate-500">perfect</span> 
            <br />
            place with ease
          </h1>
          <div className="text-gray-400 mt-7 text-xs sm:text-sm ">
      ...
      <Swiper navigation>
      {
        ...
        offerListings.map((listing) => (
          <SwiperSlide>
            ...
            className="h-[500px] mt-28" key={listing._id}></div>
          </SwiperSlide>
        ))
